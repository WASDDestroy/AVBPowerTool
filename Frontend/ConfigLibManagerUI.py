...
class ConfigLibManagerUI(BaseUI.BaseUI):
    ...
    def customized_init(self):
        ...
        self.customized_function = {"M" : t("config_lib.action.manage")}
        self.config_function = {"R" : t("config_lib.action.rename"),
                                "D" : t("config_lib.action.delete"),
                                "A" : t("config_lib.action.activate"),}
